...
import 'package:sala_app/features/home_view/data/home_model/product.model.dart';
...
class ProductGrideViewItem extends StatelessWidget {
  final ProductModel productModel;

  const ProductGrideViewItem({super.key, required this.productModel});
  @override
              ...
              children: [
                Padding(
                  ...
                  child: IconButton(
                    ...
                    icon: HomeDataCubit.get(context).favoriteList[productModel.id!]!? Icon(
                        Icons.favorite,
